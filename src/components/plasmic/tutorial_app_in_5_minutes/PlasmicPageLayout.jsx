...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: FGUcxIFy-tiF/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: yueL7npe1aIN/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: oum3sq2wPHZO/icon
...
function PlasmicPageLayout__RenderFunc(props) {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg___8ALgj)}
          role={"img"}
        />
      }
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__dAwcs)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__xT5A)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <ph.DataCtxReader>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__mwdhf)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___4WW7L)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
